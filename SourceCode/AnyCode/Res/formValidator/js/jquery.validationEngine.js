...
//			field.attr("class"));
		...
		*/
		 _ajax: function(field, rules, i, options) {
			 ...
			 var extraData = rule.extraData+","+$("#Id").val();
			 ...
			 if (!options.isError) {
			     $.ajax({
			         ...
			         data: {
			             ...
			             "ExtraData": extraData,
			             "ExtraDataDynamic": extraDataDynamic
			         },
			         field: field,
			         rule: rule,
					 methods: methods,
					 ...
					 success: function(json) {
					     ...
					     var errorFieldId = json.ErrorFieldId;
						 //var errorField = $($("#" + errorFieldId)[0]);
		...
		*/
		_calculatePosition: function (field, promptElmt, options) {
			...
			return {
				...
				"callerleftPosition": (promptleftPosition+10) + "px",//--meter-- Ôö¼Ó10px
